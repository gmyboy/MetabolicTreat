...
import com.shwootide.metabolictreat.fragment.MedicalRecord.ReDiagnosisRecordFragment;
 ...
 */
public class ReDiagnosisPageAdapter extends FragmentPagerAdapter {
    private final String[] TITLES_re = {"病史","体格检查", "实验室检查", "辅助检查", "诊断", "医嘱"};
    ...
    public ReDiagnosisPageAdapter(FragmentManager fm, String illnessid, int position, int sequenceNumber) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                fragment = ReDiagnosisRecordFragment.newInstance(illnessid, mPosition, mSequenceNumber);
                break;
            case 1:
