...
/**
 * 血糖监测
 * Created by GMY on 2015/9/23 10:05.
 * Contact me via email gmyboy@qq.com.
 */
public class MHistory_sugar implements Parcelable {

    /**
     * nametype2id : 400
     * reference : 4.4-6.1mmol/L
     * score : 0.0
     * IllnessName : 糖尿病
     * IllnessID : 1
     * editMode : 0
    ...
    public MHistory_sugar() {
    }

    protected MHistory_sugar(Parcel in) {
    ...
    public static final Parcelable.Creator<MHistory_sugar> CREATOR = new Parcelable.Creator<MHistory_sugar>() {
        public MHistory_sugar createFromParcel(Parcel source) {
            return new MHistory_sugar(source);
        }

        public MHistory_sugar[] newArray(int size) {
            return new MHistory_sugar[size];
        }
    };
}
